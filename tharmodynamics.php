<?php 
    ...
    $query = "SELECT * FROM question WHERE sector = 'Tharmodynamics' ORDER BY question_id LIMIT 4 ";
    ...
    <div class="content">
        ...
        <div class="header">
            <div class="row">
                <div class="col-md-3">
                    <div class="logoarea">
                        <a href="index.php"><img src="img/E-2.png" alt="EngineersCafe" class="img-thumbnail"></a>
                    </div>
                </div>
        ...
        <div class="main_Content">
            ...
            <!-- fetching data from database -->
                <div class="col-md-6">
                    ...
                    <h3><a href="index.php">Home</a><a href="english.php">/Tharmodynamics</a></h3>
                        <?php
